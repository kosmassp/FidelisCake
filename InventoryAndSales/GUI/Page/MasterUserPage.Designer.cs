namespace InventoryAndSales.GUI.Page
{
  partial class MasterUserPage
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.dataGridViewUserMaster.Location = new System.Drawing.Point(21, 20);
      ...
      this.Controls.Add(this.groupBoxUserMaster);
      this.Controls.Add(this.dataGridViewUserMaster);
      this.Controls.Add(this.buttonDeleteUserMaster);
      this.Controls.Add(this.buttonEditUserMaster);
      this.Controls.Add(this.buttonAddUserMaster);
      this.Name = "MasterUserPage";
      this.Size = new System.Drawing.Size(1071, 657);
